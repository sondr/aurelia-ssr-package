define(["require", "exports", "./jsdom/bootstrapper/ssr-bootstrapper-webpack", "./jsdom/ssr-engine/aurelia-ssr-engine", "./jsdom/pal-nodejs/index", "./jsdom/middleware-koa/aurelia-middleware-koa", "./linkedom/bootstrapper/ssr-bootstrapper-webpack", "./linkedom/ssr-engine/aurelia-ssr-engine", "./linkedom/pal-nodejs/index", "./linkedom/middleware-koa/aurelia-middleware-koa", "./happydom/bootstrapper/ssr-bootstrapper-webpack", "./happydom/ssr-engine/aurelia-ssr-engine", "./happydom/pal-nodejs/index", "./happydom/middleware-koa/aurelia-middleware-koa"], function (require, exports, bootstrapper, ssrEngine, palNodeJS, aureliaKoaMiddleware, linkedomBootstrapper, linkedomSsrEngine, linkedomPalNodeJS, linkedomAureliaKoaMiddleware, happydomBootstrapper, happydomSsrEngine, happydomPalNodeJS, happydomAureliaKoaMiddleware) {
    ...
    exports.happydomBootstrapper = happydomBootstrapper;
    exports.happydomSsrEngine = happydomSsrEngine;
    exports.happydomPalNodeJS = happydomPalNodeJS;
    exports.happydomAureliaKoaMiddleware = happydomAureliaKoaMiddleware;
});
