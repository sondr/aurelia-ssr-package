...
export default class SelectorItem {
     ...
     */
    matchesPsuedo(element, selector) {
     ...
     * @returns True if it is a match.
     */
    matchesNthChild(element, psuedo, place) {
     ...
     * @returns True if it is a match.
     */
    matchesPsuedoExpression(element, psuedo) {
     ...
     * @returns True if it is a match.
     */
    matchesAttributeName(element, attributeName) {
     ...
     * @param matchType
     */
    matchesAttributeNameAndValue(element, attributeName, attributeValue, matchType = null) {
