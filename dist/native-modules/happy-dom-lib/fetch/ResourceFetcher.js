...
var ResourceFetcher = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
                            throw new DOMException("Failed to perform request to \"".concat(options.url, "\". Status code: ").concat(response.status));
                        }
    ...
    ResourceFetcher.fetchSync = function (options) {
        var url = RelativeURL.getAbsoluteURL(options.window.location, options.url);
        var request = null;
        try {
        ...
        if (response.isError()) {
            throw new DOMException("Failed to perform request to \"".concat(url, "\". Status code: ").concat(response.statusCode));
        }
