System.register(["../nodes/node/Node", "./SelectorItem", "../nodes/node/NodeListFactory"], function (exports_1, context_1) {
    "use strict";
    var Node_1, SelectorItem_1, NodeListFactory_1, SELECTOR_PART_REGEXP, QuerySelector;
    ...
    return {
        ...
        execute: function () {
            SELECTOR_PART_REGEXP = /(\[[^\]]+\]|[a-zA-Z0-9-_.#"*:()\]]+)|([ ,>]+)/g;
            ...
            exports_1("default", QuerySelector);
        }
    };
});
